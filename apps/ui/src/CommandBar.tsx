 ...
 * fresh open re-seeds even when the text is unchanged): `navigate` mode selects
 * the seeded url so typing replaces it, while `new-tab` mode opens empty and only
 * places the caret. The overlay's visibility is driven by main showing/hiding the
 * hosting view, so the panel always renders.
 */
